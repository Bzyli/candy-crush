...
class DragManager():
    ...
    def on_drop(self, event):
        ...
        print((self.get_widget_id(widget) - 1 ))
        print((self.get_widget_id(widget) - 1 ) // SIZE)
...
def guillotiere(grille, liste_coord):#en référence à une célèbre place forte lyonnaise
    """
    """
    print(liste_coord, "guillotiere")
    liste_a_traiter = liste_coord[::-1]
    liste_colonne_0 = []
    while len(liste_a_traiter) != 0:
        print(liste_a_traiter, "guillotiere 1")
        current_coords = liste_a_traiter.pop()
        print(current_coords, "guillotiere 2")
    ...
    print(liste_colonne_0, "guillotiere 3")
